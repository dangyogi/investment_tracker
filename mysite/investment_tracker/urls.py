...
urlpatterns = [
    ...
    path('load_transactions/<date:end_date>', views.load_transactions),
    path('load_transactions/<date:end_date>/<filename>',
    ...
    path('get_plan/<cat_name>/<int:account_id>/tags/<tags>', views.get_plan),
    ...
    path('get_children/<cat_name>/tags/<tags>', views.get_children),
    ...
    path('rebalance/<int:owner_id>/tags/<tags>', views.rebalance, name='default_rebalance'),
    path('rebalance/<int:owner_id>/<float:adj_pct>', views.rebalance,
         name='adj_rebalance'),
    path('rebalance/<int:owner_id>/<float:adj_pct>/tags/<tags>', views.rebalance,
         name='adj_rebalance'),
    path('rebalance/<int:owner_id>/<float:adj_pct>/<filename>', views.rebalance,
         name='adj_rebalance_filename'),
    path('rebalance/<int:owner_id>/<float:adj_pct>/<filename>/tags/<tags>', views.rebalance,
         name='adj_rebalance_filename'),
